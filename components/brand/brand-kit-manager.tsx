      ...
      >
        ...
        {[
          ...
          <label className="block space-y-2 text-sm font-medium" key={key}>
            <span>{label}</span>
            <input
              className="w-full rounded-2xl border border-white/10 bg-black px-4 py-3 outline-none ring-cyan-300 transition focus:border-cyan-300/80 focus:ring-2"
              onChange={(event) =>
                setForm((current) => ({
                  ...current,
        ...
        <label className="block space-y-2 text-sm font-medium">
          <span>Voice</span>
          <textarea
            className="min-h-24 w-full rounded-2xl border border-white/10 bg-black px-4 py-3 outline-none ring-cyan-300 focus:border-cyan-300/80 focus:ring-2"
            onChange={(event) =>
